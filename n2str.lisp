...
(defun n2str999 (n &optional (gender nil)(l 'ua)(dig nil)(chgen nil))
  (setf digit
        `(0 (ua "нуль"    ru "ноль"   en "zero")
          ...
          11 (ua "одинадцять"     ru "одиннадцать"  en "eleven")
...
;;            для чисел від 0 до 999*10^99 у правильному напрямку
...
(defun n2str (n &optional (gender nil)(l 'ua)(d nil)(sf nil))
  (setf rr nil)
  (setf da
        `(ua ("децілліон" "нонілліон" "октілліон"
              "септілліон" "секстильйон" "квінтильйон"
